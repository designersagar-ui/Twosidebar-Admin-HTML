...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        sidebar.attr('style', 'min-height:' + sideheight + 'px');
    };
    ...
    // Hanles second sidebar toggler
    var handleSecondSidebarToggler = function () {
        var body = $('body');
        if ($.cookie && $.cookie('sidebar_closed_2') === '1' && App.getViewPort().width >= resBreakpointMd) {
            $('body').addClass('page-second-sidebar-closed');
            $('.page-second-sidebar-menu').addClass('page-second-sidebar-menu-closed');
        }

        // handle sidebar show/hide
        $('body').on('click', '.sidebar-toggler-second', function (e) {
            var sidebar = $('.page-sidebar');
            var sidebarMenu = $('.page-second-sidebar-closed');
            $(".sidebar-search", sidebar).removeClass("open");

            if (body.hasClass("page-second-sidebar-closed")) {
                body.removeClass("page-second-sidebar-closed");
                sidebarMenu.removeClass("page-second-sidebar-menu-closed");
                if ($.cookie) {
                    $.cookie('sidebar_closed_2', '0');
                }
            } else {
                body.addClass("page-second-sidebar-closed");
                sidebarMenu.addClass("page-second-sidebar-menu-closed");
                if (body.hasClass("page-sidebar-fixed")) {
                    sidebarMenu.trigger("mouseleave");
                }
                if ($.cookie) {
                    $.cookie('sidebar_closed_2', '1');
                }
            }
    ...
    return {
        ...
        initSidebar: function () {
            ...
            handleSecondSidebarToggler() // handles second sidebar hide/show
